...
import UpdateEmployeesScreen from './UpdateEmployeesScreen'
...
const UpdateEmployees = () => {
    ...
    return (
        <>
        <UpdateEmployeesScreen initialValues={initialValues} validationSchema={validationSchema} onSubmit={onSubmit} jobShift={jobShift} jobTitle={jobTitle} department={department} gender={gender} />    
        </>
    )
}
